              ...
              <div>
                ...
                <div className="mt-4 bg-blue-50 border-l-4 border-blue-500 p-4">
                  ...
                  <p className="text-sm text-blue-900 mb-2">
                    Az online bankkártyás fizetést a <strong>Barion Payment Zrt.</strong> (1117 Budapest, Infopark sétány 1., I. épület 5. emelet) biztosítja.
                  </p>
                  <p className="text-sm text-blue-900 mb-2">
                    <strong>Az online bankkártyás és egyéb fizetési módok a Barion rendszerén keresztül valósulnak meg.
                    A bankkártya, illetve egyéb fizetéssel kapcsolatos adatok a kereskedőhöz nem jutnak el.
                    A szolgáltatást nyújtó Barion Payment Zrt. a Magyar Nemzeti Bank felügyelete alatt álló intézmény,
                    engedélyének száma: H-EN-I-1064/2013.</strong>
                  </p>
                  <p className="text-sm text-blue-900 mb-2">
