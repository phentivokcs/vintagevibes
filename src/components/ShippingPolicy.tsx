import { ArrowLeft, Package, Truck, RotateCcw, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Szállítási és Visszaküldési Feltételek</h1>
